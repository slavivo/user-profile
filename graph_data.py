graph_data = {
  "data": {
    "nodes": [
      ...
      {
        "data": {
          "id": "data_transmission_compression",
    ...
    "edges": [
      ...
      },
      {
        "data": {
          "source": "data_types",
          "target": "information_encoding"
        }
      },
      {
        "data": {
          "source": "information_encoding",
          "target": "text_encoding_encryption"
        }
      },
      {
        "data": {
          "source": "information_encoding",
          "target": "image_sound_encoding"
        }
      },
      {
        "data": {
          "source": "information_encoding",
          "target": "number_systems_encoding"
        }
      },
      {
        "data": {
          "source": "data_collection_recording",
      ...
      },
      {
        "data": {
          "source": "data_modeling",
          "target": "graph_based_modeling"
        }
      },
      {
        "data": {
          "source": "graph_based_modeling",
          "target": "modeling_simulation"
        }
      },
      {
        "data": {
          "source": "text_encoding_encryption",
      ...
      },
      {
        "data": {
          "source": "information_encoding",
          "target": "data_transmission_compression"
        }
      },
      {
        "data": {
  ...
  "algorithms": {
    "nodes": [
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "at_steps",
              "name": "Break down problems into sequential steps",
              "mastered": False,
              "grade": "5th_grade"
            },
            {
              "id": "at_flowchart",
              "name": "Create flowcharts to represent algorithms",
              "mastered": False,
              "grade": "6th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "pr_identify",
              "name": "Identify patterns in data and processes",
              "mastered": False,
              "grade": "5th_grade"
            },
            {
              "id": "pr_apply",
              "name": "Apply pattern recognition to solve problems",
              "mastered": False,
              "grade": "7th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "ve_use",
              "name": "Use variables to store and manipulate data",
              "mastered": False,
              "grade": "6th_grade"
            },
            {
              "id": "ve_express",
              "name": "Write mathematical expressions in code",
              "mastered": False,
              "grade": "7th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "cs_if",
              "name": "Use if-statements for decision making",
              "mastered": False,
              "grade": "6th_grade"
            },
            {
              "id": "cs_complex",
              "name": "Implement complex conditional statements",
              "mastered": False,
              "grade": "7th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "lc_for",
              "name": "Write for loops to repeat actions",
              "mastered": False,
              "grade": "7th_grade"
            },
            {
              "id": "lc_while",
              "name": "Use while loops and loop conditions",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "f_create",
              "name": "Create and call simple functions",
              "mastered": False,
              "grade": "7th_grade"
            },
            {
              "id": "f_params",
              "name": "Work with function parameters and return values",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "a_basic",
              "name": "Create and modify arrays",
              "mastered": False,
              "grade": "7th_grade"
            },
            {
              "id": "a_ops",
              "name": "Perform operations on arrays (sorting, searching)",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "oop_class",
              "name": "Create simple classes and objects",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "pd_plan",
              "name": "Plan and design programs before coding",
              "mastered": False,
              "grade": "7th_grade"
            },
            {
              "id": "pd_implement",
              "name": "Implement and test program designs",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      {
        "data": {
          "id": "logical_statements_expressions",
          "label": "Logical Statements and Expressions",
          "learning_goals": [
            {
              "id": "lse_basic",
              "name": "Write basic logical expressions",
              "mastered": False,
              "grade": "6th_grade"
            },
            {
              "id": "lse_complex",
              "name": "Combine logical operators in complex expressions",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "pl_syntax",
              "name": "Understand basic programming language syntax",
              "mastered": False,
              "grade": "7th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "co_improve",
              "name": "Identify and improve inefficient code",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "dt_find",
              "name": "Find and fix program errors",
              "mastered": False,
              "grade": "7th_grade"
            },
            {
              "id": "dt_test",
              "name": "Create test cases for programs",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
    ...
    "edges": [
      ...
      },
      {
        "data": {
          "source": "algorithmic_thinking",
          "target": "control_structures"
        }
      },
      {
        "data": {
          "source": "variables_expressions",
          "target": "control_structures"
        }
      },
      {
        "data": {
          "source": "control_structures",
          "target": "loops_conditions"
        }
      },
      {
        "data": {
      ...
      },
      {
        "data": {
          "source": "arrays",
          "target": "object_oriented_programming"
        }
      },
      {
        "data": {
          "source": "pattern_recognition",
          "target": "program_development"
        }
      },
      {
        "data": {
          "source": "logical_statements_expressions",
          "target": "control_structures"
        }
      },
      {
        "data": {
          "source": "program_development",
      ...
      },
      {
        "data": {
          "source": "algorithmic_thinking",
          "target": "logical_statements_expressions"
        }
      }
    ]
  },
    ...
    "nodes": [
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "os_basic",
              "name": "Understand basic OS functions and components",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "os_manage",
              "name": "Manage files and processes in an OS",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "sa_components",
              "name": "Identify main components of computer systems",
              "mastered": False,
              "grade": "7th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "cn_types",
              "name": "Understand different types of networks",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "cn_protocols",
              "name": "Explain basic network protocols",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "i_works",
              "name": "Explain how the Internet works",
              "mastered": False,
              "grade": "7th_grade"
            },
            {
              "id": "i_services",
              "name": "Use various Internet services responsibly",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "cc_concept",
              "name": "Understand the concept of cloud computing",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      {
        "data": {
          "id": "databases_systems",
          "label": "Databases Systems",
          "learning_goals": [
            {
              "id": "dbs_types",
              "name": "Compare different types of database systems",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "wdd_html",
              "name": "Create basic web pages using HTML",
              "mastered": False,
              "grade": "7th_grade"
            },
            {
              "id": "wdd_css",
              "name": "Style web pages using CSS",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "ma_design",
              "name": "Design simple mobile applications",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "uid_principles",
              "name": "Apply basic UI design principles",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "uid_usability",
              "name": "Evaluate interface usability",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "ss_threats",
              "name": "Identify common security threats",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "ss_protect",
              "name": "Apply basic system protection measures",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      {
        "data": {
          "id": "data_management_systems",
          "label": "Data Management Systems",
          "learning_goals": [
            {
              "id": "dms_organize",
              "name": "Organize and manage data effectively",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "ds_concept",
              "name": "Understand basic concepts of distributed computing",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
    ...
    "edges": [
      ...
      },
      {
        "data": {
          ...
          "target": "computer_networks"
        }
      },
      {
        "data": {
          "source": "computer_networks",
          "target": "internet"
        }
      },
      {
      ...
      {
        "data": {
          "source": "cloud_computing",
          "target": "distributed_systems"
        }
      },
      {
        "data": {
          "source": "databases_systems",
          "target": "data_management_systems"
        }
      },
      {
        "data": {
          "source": "internet",
          "target": "web_design_development"
        }
      },
      {
        "data": {
          "source": "web_design_development",
          "target": "user_interface_design"
        }
      },
      {
        "data": {
          "source": "mobile_applications",
          "target": "user_interface_design"
        }
      },
      {
      ...
      {
        "data": {
          "source": "data_management_systems",
          "target": "distributed_systems"
        }
      },
      {
  ...
  "digital": {
    "nodes": [
      {
        "data": {
          "id": "hardware_fundamentals",
          "label": "Hardware Fundamentals",
          "learning_goals": [
            {
              "id": "hf_components",
              "name": "Identify basic computer hardware components",
              "mastered": False,
              "grade": "6th_grade"
            },
            {
              "id": "hf_function",
              "name": "Explain the function of main hardware components",
              "mastered": False,
              "grade": "7th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "dl_gates",
              "name": "Understand basic logic gates",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "dl_circuits",
              "name": "Design simple digital circuits",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      {
        "data": {
          "id": "input_output_systems",
          "label": "Input/Output Systems",
          "learning_goals": [
            {
              "id": "ios_types",
              "name": "Identify different types of I/O devices",
              "mastered": False,
              "grade": "6th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          "id": "sensors_iot",
          "label": "Sensors and IoT",
          "learning_goals": [
            {
              "id": "siot_basic",
              "name": "Understand basic sensor types and their uses",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "siot_connect",
              "name": "Explain IoT device connectivity",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "ai_basic",
              "name": "Understand basic AI concepts",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "ai_apps",
              "name": "Identify AI applications in daily life",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "ml_concept",
              "name": "Understand basic machine learning concepts",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "cv_basic",
              "name": "Understand how computers process images",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "nlp_basic",
              "name": "Understand how computers process text",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "r_basic",
              "name": "Understand basic robotics concepts",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "r_program",
              "name": "Program simple robot behaviors",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "hci_principles",
              "name": "Apply basic HCI principles",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "dc_methods",
              "name": "Use different digital communication methods",
              "mastered": False,
              "grade": "7th_grade"
            },
            {
              "id": "dc_safety",
              "name": "Practice safe digital communication",
              "mastered": False,
              "grade": "8th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "cs_protect",
              "name": "Apply basic cybersecurity practices",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "cs_threats",
              "name": "Identify common cyber threats",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      },
      {
        "data": {
          ...
          "learning_goals": [
            {
              "id": "et_trends",
              "name": "Identify current technology trends",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
      ...
      {
        "data": {
          "id": "technology_ethics_society",
          "label": "Technology Ethics and Society",
          "learning_goals": [
            {
              "id": "tes_impact",
              "name": "Evaluate the impact of technology on society",
              "mastered": False,
              "grade": "8th_grade"
            },
            {
              "id": "tes_ethical",
              "name": "Consider ethical implications of technology use",
              "mastered": False,
              "grade": "9th_grade"
            }
          ]
    ...
    "edges": [
      {
        "data": {
          "source": "hardware_fundamentals",
          "target": "digital_logic"
        }
      },
      {
        "data": {
          "source": "digital_logic",
          "target": "input_output_systems"
        }
      },
      {
        "data": {
      ...
      },
      {
        "data": {
          "source": "artificial_intelligence",
          "target": "emerging_technologies"
        }
      },
      {
        "data": {
          "source": "machine_learning",
          "target": "technology_ethics_society"
        }
      },
      {
        "data": {
